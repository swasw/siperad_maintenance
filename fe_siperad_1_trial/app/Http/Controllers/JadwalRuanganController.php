...
class JadwalRuanganController extends BaseController
{
    ...
    public function index()
    {
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_URL => $this->backendUrl . "/api/jadwalruang/index",
    ...
    public function viewindex(Request $request)
    {
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_URL => $this->backendUrl . "/api/lihat-jadwalruang/index",
    ...
    public function store(Request $request)
    {
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_URL => $this->backendUrl . "/api/jadwalruang/post",
    ...
    public function edit($id)
    {
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_URL => $this->backendUrl . "/api/jadwalruang/{$id}",
    ...
    public function destroyAll()
    {
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_URL => $this->backendUrl . "/api/jadwalruang/hapus-semua",
