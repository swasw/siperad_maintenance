        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('matkul.create') }}" class="btn btn-sm btn-primary">Tambah data</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td>{{ $d['mata_kuliah'] }}</td>
                                    <td>
                                        <a href="{{ route('matkul.destroy', $d['id']) }}" class="btn btn-sm btn-danger"
                                        ...
                                        <a href="{{ route('matkul.edit', $d['id']) }}" class="btn btn-sm btn-primary"><i
