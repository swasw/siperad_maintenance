            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('barang.update', $data['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            <label for="deskripsi_barang">Deskripsi Alat (<small id="emailHelp"
                        ...
                        <div class="form-group mb-2">
                            <label for="stok">Stok Alat (<small id="emailHelp" class="form-text text-muted">Satuan
                                    pcs</small>)</label>
                            <input type="number" class="form-control" name="stok" value="{{ $data['stok'] }}"
                                id="stok" required>
                        </div>
                        <div class="form-group mb-2">
                            <label for="nama_barang">Status Alat</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_barang" id="tersedia"
                                    value="{{ 1 }}" {{ $data['status_barang'] == 1 ? 'Checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_barang" id="tidak_tersedia"
                                    value="{{ 0 }}" {{ $data['status_barang'] == 0 ? 'Checked' : '' }}>
